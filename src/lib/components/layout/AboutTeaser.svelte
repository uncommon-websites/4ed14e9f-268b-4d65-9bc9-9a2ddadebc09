...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		name: "Learco Finck",
		role: "Founder & CEO",
		image: "/generated/image-editorial-corporate-portrait-of-a-profes.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"After 12 years placing executives at Booking.com and building The Big Search, I watched the same pattern repeat: brilliant recruiters drowning in spreadsheets while the best candidates slipped through the cracks. The industry wasn't missing talent. It was missing infrastructure."`}
			/>
